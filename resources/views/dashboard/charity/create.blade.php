...
@section('content')
    <div class="container d-flex justify-content-center">
        <div class="card w-75">
            <div class="card-header">Create a new charity</div>
            <div class="card-body">
                <form action="/charity/store" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="charity_title" name="charity_title" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="charity_desc" id="charity_desc" cols="30" rows="5" class="form-control"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="charity_excerpt">Excerpt</label>
                        <input type="text" id="charity_excerpt" name="charity_excerpt" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="charity_location" name="charity_location" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="charity_date" name="charity_date" class="form-control">
                    </div>

                    <button type="submit" class="btn btn-primary float-right" value="SIMPAN">Create Charity</button>
                </form>
            </div>
        </div>
    </div>
